...
Labeling only. The route/nav-log view briefly lived here too, because
this service already had the sectional tile layer working, but it moved
to planner-ui once it grew a nav log and on-demand collection -- those
need shapely/pyshp and the whole vfr.pipeline import chain, which is a
lot to carry in a dev-only labeling tool.
"""
import csv
import io
import math
