 ...
 *  a nav log for a route this pilot planned. {@code aircraftId}/{@code routeId}
 *  are both optional: a flight can be filed without a saved aircraft or
 *  a persisted {@code Route} row, the same way {@link com.northflyers.vfr.domain.Flight}
 *  itself allows both to be null. */
